...
<head>
	...
	<link rel="stylesheet" type="text/css" href="assets/css/vid.css">
...
<body class="home">
			...
			<nav id="nav" class="navv">
				...
				<ul>
					...
					<li><a href="#"><i class="fa fa-language" aria-hidden="true"></i>&nbsp;Language</a>
							<ul>
								<li><a href="videos"><img alt="" src="assets/img/gb.png" alt="us">&nbsp;&nbsp;English</a></li>
								<li><a href="gj/videos"><img alt="" src="assets/img/in.png" alt="us">&nbsp;&nbsp;Gujarati</a></li>
							</ul>
						</li>
	...
	<div class="q-container">
		<div class="q-row">
			<div class="q-col-1-1">
				<ul class="breadcrumb">
					<li>You are here:<a href="index" class="marg">Home</a><span class="marg">/</span><a href="album" class="marg">Videos</a></li>
