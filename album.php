...
<head>
	...
	<link rel="stylesheet" type="text/css" href="assets/css/album-css.css">
	<!-- Loading Modenizr -->
		...
		<div class="q-container">
			...
			<nav id="nav" class="navv">
				...
				<ul>
					...
					<li class="nav-special"><a href="#"><i class="fa fa-picture-o" aria-hidden="true"></i>&nbsp;Gallery</a>
						<ul>
					...
					<li><a href="#"><i class="fa fa-language" aria-hidden="true"></i>&nbsp;Language</a>
						<ul>
							<li><a href="album"><img alt="" src="assets/img/gb.png" alt="us">&nbsp;&nbsp;English</a></li>
							<li><a href="gj/album"><img alt="" src="assets/img/in.png" alt="us">&nbsp;&nbsp;Gujarati</a></li>
						</ul>
					</li>
	...
	<main id="main">
		<div class="page-body">
			<section class="section">
				<div class="q-container">
					<div class="q-row">
						<h2 class="section-headline wow animated fadeInLeft animated center-txt">Videos</h2>
						<?php
