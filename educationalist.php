...
<html>
	<head>
		...
		<title>Educationalist - Praful Patel(President of the AIFF, Member of Parliament, Govt. of India, Senior Leader NCP.)</title>
      ...
      <link rel="stylesheet" type="text/css" href="assets/css/custom.css">
       <link rel="stylesheet" type="text/css" href="assets/css/edu-css.css">
		<!-- Loading: Styles -->
	...
	<body class="home">
				...
				<nav id="nav" class="navv">
					...
					<ul>
						...
						<li><a href="#"><i class="fa fa-language" aria-hidden="true"></i>&nbsp;Language</a>
							<ul>
								<li><a href="educationalist"><img alt="" src="assets/img/gb.png" alt="us">&nbsp;&nbsp;English</a></li>
								<li><a href="gj/educationalist"><img alt="" src="assets/img/in.png" alt="us">&nbsp;&nbsp;Gujarati</a></li>
							</ul>
						</li>
		...
		<div class="q-container">
			<div class="q-row">
				<div class="q-col-1-1">
					<ul class="breadcrumb">
					  <li>You are here:<a href="index" class="marg">Home</a><span class="marg">/</span><a href="about" class="marg">About</a></li>
					  <li>Educationalist</li>
					</ul>
				</div>
			</div>
		</div>		
		...
		<div class="q-container main-cont">
			<div class="q-row">
				<div class="q-col-1-1 center-txt">
					<h2 class="section-headline wow animated fadeInLeft animated center-txt hdng-marg" style="">Educationalist</h2>
					<img alt="" src="assets/img/praful-patel-educationalist.png">
					<p class="hdng-marg">The philanthropy works of his family began with many educational institutions in the Bhandara-Gondia district started by his father. 
					His father started twenty-two schools in one day in a district which only had one school philanthropy until then was a rare achievement. 
					Stepping into his father’s shoes, Praful Patel never forgot what his father said to him in his young days, 
					“Your first commitment is to the society, and its development is your prime duty.” Patel family runs Gondia Education Society along with host 
					of several educational and charitable trusts. The Gondia Education Society imparts education to 1,10,000 students in all disciplines ranging from Arts, 
					Commerce, Engineering, Law, Information Technology (IT) and Computer Sciences to Pharmacy. Apart from Gondia Education Society, Patel family a staunch 
					believer in the importance of education, also founded the The Nadiad Education Society in Gujarat, which imparts education in all vocational and graduates 
					courses.</p>
				</div>
			</div>	
		</div>
