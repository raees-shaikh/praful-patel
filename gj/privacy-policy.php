...
<html>
	<head>
		...
		<title>Privacy Policy - Praful Patel(President of the AIFF, Member of Parliament, Govt. of India, Senior Leader NCP.)</title>
	...
	<body class="home">
			...
			<div class="q-container">
				...
				<nav id="nav" class="navv">
					...
					<ul>
						...
						<li><a href="social"><i class="fa fa-language" aria-hidden="true"></i>&nbsp;ભાષા</a>
                            <ul>
                                <li><a href="../privacy-policy"><img alt="" src="assets/img/gb.png" alt="us">&nbsp;&nbsp;અંગ્રેજી</a></li>
                                <li><a href="privacy-policy"><img alt="" src="assets/img/in.png" alt="us">&nbsp;&nbsp;ગુજરાતી</a></li>
                            </ul>
						</li>
		...
		<div class="q-container main-cont">
			<div class="q-row">
				<div class="q-col-1-1">
				<h2 class="section-headline wow animated fadeInLeft animated center-txt">Privacy Policy</h2>
