			...
			<nav id="nav" class="navv">
				...
				<ul>
					...
					<li><a href="#"><i class="fa fa-language" aria-hidden="true"></i>&nbsp;ભાષા</a>
						<ul>
							<li><a href="../album"><img alt="" src="assets/img/gb.png" alt="us">&nbsp;&nbsp;અંગ્રેજી</a></li>
							<li><a href="album"><img alt="" src="assets/img/in.png" alt="us">&nbsp;&nbsp;ગુજરાતી</a></li>
						</ul>
					</li>
	...
	<main id="main">
		<div class="page-body">
			<section class="section">
				<div class="q-container">
					<div class="q-row">
						<h2 class="section-headline wow animated fadeInLeft animated center-txt down-app">વિડિઓ</h2>
						<?php
						$sql = "SELECT id,albumCoverLink,name FROM album1 WHERE status=1 AND flag=0";
						$result = mysqli_query($db_app, $sql);
						if (mysqli_num_rows($result) > 0) {
							while ($row = mysqli_fetch_assoc($result)) { ?>

								<div class="q-col-1-4 new center-txt">
									<?php
									@$albumid[$i] = $row['id'];
									$albumname[$i] = $row['name'];
									//echo "<a href='videos?albumid='".$albumid[$i]."&name=".$albumname."> </a>"
									echo '<a href="videos?albumid=' . @$albumid[$i] . '&name=' . $albumname[$i] . '" onclick="post"><img alt="" src="' . $row["albumCoverLink"] . '" width="200" height="200"></a><br>';
									?><h4><?php echo $row['name']; ?></h4><?php
																			@$i++;
																			?></div><?php
																		}
																	} else {
