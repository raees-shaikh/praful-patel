...
<html>
	<head>
		...
		<title>Positions Held - Praful Patel(President of the AIFF, Member of Parliament, Govt. of India, Senior Leader NCP.)</title>
 ...
 <!--  <link rel='stylesheet prefetch' href='https://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/css/bootstrap.min.css'> -->
      ...
      <link rel="stylesheet" type="text/css" href="assets/css/held.css">
		<!-- Loading Modenizr -->
	...
	<body class="home">
				...
				<nav id="nav" class="navv">
					...
					<ul>
						...
						<li><a href="#"><i class="fa fa-language" aria-hidden="true"></i>&nbsp;ભાષા</a>
                            <ul>
                                <li><a href="../positions-held"><img alt="" src="assets/img/gb.png" alt="us">&nbsp;&nbsp;અંગ્રેજી</a></li>
                                <li><a href="positions-held"><img alt="" src="assets/img/in.png" alt="us">&nbsp;&nbsp;ગુજરાતી</a></li>
                            </ul>
						</li>
        ...
        <div class="q-container clr">
            <div class="q-row">
                <div class="q-col-1-1">
                    <ul class="breadcrumb">
                      <li>You are here:<a href="index" class="marg">મુખ્ય પૃષ્ઠ</a></li>
                      <li>સંભાળેલા હોદ્દાઓ</li>
                    </ul>
                </div>
            </div>
        </div>
		<div class="q-container main-cont">
			<h2 class="section-headline wow animated fadeInLeft animated center-txt">સંભાળેલા હોદ્દાઓ</h2><br><br>
        ...
        <div class="col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2">
            <ul class="timeline timeline-centered">
                <li class="timeline-item">
                    <div class="timeline-info">
                        <!-- <span style="margin-right: 2%;">March 12, 2016</span> -->
                    </div>
                    <div class="timeline-marker"></div>
                    <div class="timeline-content">
                        <h3 class="timeline-title h3">1985: President, Municipal Council, Gondia (Maharashtra)</h3>
                        <p class="pc"></p>
                    </div>
                </li>
                <li class="timeline-item">
                    <div class="timeline-info">
                        <!-- <span style="margin-left: 3%;">March 23, 2016</span> -->
                    </div>
                    <div class="timeline-marker"></div>
                    <div class="timeline-content">
                        <h3 class="timeline-title h4">1991: Elected to 10th Lok Sabha</h3>
                        <p class="pcc"></p>
                    </div>
                </li>
            ...
            <ul class="timeline timeline-centered">
                <li class="timeline-item">
                    ...
                    <div class="timeline-marker"></div>
                    <div class="timeline-content">
                        <h3 class="timeline-title h3">1991-96: Member, Consultative Committee, Ministry of Environment and Forests</h3>
                        <p class="pc"></p>
                    </div>
                </li>
                <li class="timeline-item">
                    ...
                    <div class="timeline-marker"></div>
                    <div class="timeline-content">
                        <h3 class="timeline-title h4">1994-95: Member, Committee on Science and Technology</h3>
                        <p class="pcc"></p>
                    </div>
                </li>
                <li class="timeline-item period">
                ...
                <li class="timeline-item">
                    ...
                    <div class="timeline-marker"></div>
                    <div class="timeline-content">
                        <h3 class="timeline-title h3">1995-96: Member, Committee on Home Affairs</h3>
                        <p class="pc"></p>
                    </div>
                </li>
                <li class="timeline-item">
                    ...
                    <div class="timeline-marker"></div>
                    <div class="timeline-content">
                        <h3 class="timeline-title h4">1996: Re-elected to 11th Lok Sabha (2nd term)</h3>
                        <p class="pcc"></p>
                    </div>
                </li>
                <li class="timeline-item period">
                ...
                <li class="timeline-item">
                    ...
                    <div class="timeline-marker"></div>
                    <div class="timeline-content">
                        <h3 class="timeline-title h3">1996-97: Member, Committee on Finance; Member, Consultative Committee, Ministry of Civil Aviation</h3>
                        <p class="pc"></p>
                    </div>
                </li>
                <li class="timeline-item">
                    ...
                    <div class="timeline-marker"></div>
                    <div class="timeline-content">
                        <h3 class="timeline-title h4">1998: Re-elected to 12th Lok Sabha (3rd term)</h3>
                        <p class="pcc"></p>
                    </div>
                </li>
                <li class="timeline-item period">
                ...
                <li class="timeline-item">
                    ...
                    <div class="timeline-marker"></div>
                    <div class="timeline-content">
                        <h3 class="timeline-title h3">2000: Elected to Rajya Sabha</h3>
                        <p class="pc"></p>
                    </div>
                </li>
                <li class="timeline-item">
                    ...
                    <div class="timeline-marker"></div>
                    <div class="timeline-content">
                        <h3 class="timeline-title h4">2004: Union Minister of State (Independent Charge), Ministry of Civil Aviation</h3>
                        <p class="pcc"></p>
                    </div>
                </li>
                <li class="timeline-item period">
            ...
            <ul class="timeline timeline-centered">
                <li class="timeline-item">
                    ...
                    <div class="timeline-marker"></div>
                    <div class="timeline-content">
                        <h3 class="timeline-title h3">2006: Re-elected to Rajya Sabha (2nd term)</h3>
                        <p class="pc"></p>
                    </div>
                </li>
                <li class="timeline-item">
                    ...
                    <div class="timeline-marker"></div>
                    <div class="timeline-content">
                        <h3 class="timeline-title h4">2009: Re-elected to 15th Lok Sabha (4th term)</h3>
                        <p class="pcc"></p>
                    </div>
                </li>
                <li class="timeline-item period">
            ...
            <ul class="timeline timeline-centered">
                <li class="timeline-item">
                    ...
                    <div class="timeline-marker"></div>
                    <div class="timeline-content">
                        <h3 class="timeline-title h3">Till 18 Jan 2011: Union Minister of State (Independent Charge), Ministry of Civil Aviation</h3>
                        <p class="pc"></p>
                    </div>
                </li>
                <li class="timeline-item">
                    ...
                    <div class="timeline-marker"></div>
                    <div class="timeline-content">
                        <h3 class="timeline-title h4">19 Jan 2011 Onwards: Union Cabinet Minister, Heavy Industries and Public Enterprises</h3>
                        <p class="pcc"></p>
                    </div>
                </li>
                <li class="timeline-item period">
