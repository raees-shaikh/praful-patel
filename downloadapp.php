...
<html>
	<head>
		...
		<title>Download App - Praful Patel</title>
	...
	<body class="home">
			...
			<div class="q-container">
				...
				<nav id="nav" class="navv">
					...
					<ul>
						...
						<li><a href="social"><i class="fa fa-language" aria-hidden="true"></i>&nbsp;Language</a>
							<ul>
								<li><a href="social"><img alt="" src="assets/img/gb.png" alt="us">&nbsp;&nbsp;English</a></li>
								<li><a href="gj/social"><img alt="" src="assets/img/in.png" alt="us">&nbsp;&nbsp;Gujarati</a></li>
							</ul>
						</li>
		...
		<div class="q-container cont-main" style="margin-top: 3%;margin-bottom: 3%;">
			<div class="q-row">
				<div class="q-col-1-1 center-txt">
					<h2 class="section-headline wow animated fadeInLeft animated center-txt hd-pd">Download App</h2>
		...
		<footer id="footer">
			...
			<div class="q-container cpy-cont">
				<div class="q-col-1-2 foo2 footer-pad">
					<p class="footer-info">© 2017 Praful Patel All Rights Reserved. | Designed & Developed By
